        ...
        <html>
            ...
            <div class="resultHeader">
                <form action="flickrcall.php" method="post" class="centerHeaderForm" autocomplete="off">
                    <input type="text" class="searchBar" name="search" placeholder="Redo Search"><br>
...
foreach($data['photos']['photo'] as $photo) { 
    $counter++;
    echo '<a href="#img' . $counter . '" onclick="return false;"><img class="large" onclick="select(this);" src="' . 'http://farm' . $photo["farm"] . '.static.flickr.com/' . $photo["server"] . '/' . $photo["id"] . '_' . $photo["secret"] . '.jpg"></a>'; 
